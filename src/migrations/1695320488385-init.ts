...
export class Init1695320488385 implements MigrationInterface {
  name = 'Init1695320488385';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('BASIC', 'CREATOR', 'ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_projects_acceslevel_enum" AS ENUM('30', '40', '50')`,
    );
    await queryRunner.query(
